...
$upd_pre_criteria = new tNG_update($conn_conn_mutya);
$tNGs->addTransaction($upd_pre_criteria);
// Register triggers
$upd_pre_criteria->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_pre_criteria->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_pre_criteria->registerTrigger("END", "Trigger_Default_Redirect", 99, "criteria_preliminary.php");
// Add columns
$upd_pre_criteria->setTable("pre_criteria");
$upd_pre_criteria->addColumn("criteria_name", "STRING_TYPE", "POST", "criteria_name");
$upd_pre_criteria->addColumn("info", "STRING_TYPE", "POST", "info");
$upd_pre_criteria->setPrimaryKey("criteria_id", "NUMERIC_TYPE", "GET", "criteria_id");
