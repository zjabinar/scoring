...
$del_contestants = new tNG_delete($conn_conn_mutya);
$tNGs->addTransaction($del_contestants);
// Register triggers
$del_contestants->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "GET", "contestant_id");
$del_contestants->registerTrigger("END", "Trigger_Default_Redirect", 99, "contestant.php?admin_id=".$curr_admin_id);
// Add columns
$del_contestants->setTable("contestants");
$del_contestants->setPrimaryKey("contestant_id", "NUMERIC_TYPE", "GET", "contestant_id");
...
<div class="dock" id="dock">
  ...
  <a class="dock-item" href="#"><img src="images/contestant.png" alt="contestant" /><span>Contact</span></a> 
