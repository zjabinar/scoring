...
$ins__admin_ = new tNG_insert($conn_conn_mutya);
...
$ins__admin_->registerTrigger("END", "Trigger_Default_Redirect", 99, "admin.php?admin_id=".$curr_admin_id);
$ins__admin_->registerConditionalTrigger("{POST.password} != {POST.re_password}", "BEFORE", "Trigger_CheckPasswords1", 50);
// Add columns
$ins__admin_->setTable("`admin`");
$ins__admin_->addColumn("username", "STRING_TYPE", "POST", "username");
$ins__admin_->addColumn("password", "STRING_TYPE", "POST", "password");
$ins__admin_->setPrimaryKey("admin_id", "NUMERIC_TYPE");
