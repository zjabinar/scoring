...
$count_criteria = $row_cri_count['pre_count'] + $row_semi_count['semi_count'];
//echo $count_criteria;


mysql_select_db($database_conn_mutya, $conn_mutya);
$query_contestants = "SELECT contestants.contestant_id, contestants.contestant_num, contestants.firstname, contestants.lastname, contestants.middlename, contestants.municipality, Avg(pre_scores.rating) AS avg_rating
FROM contestants RIGHT JOIN pre_scores ON contestants.contestant_id = pre_scores.contestant_id
GROUP BY contestants.contestant_id, contestants.contestant_num, contestants.firstname, contestants.lastname, contestants.middlename, contestants.municipality";
...
mysql_select_db($database_conn_mutya, $conn_mutya);
$query_finalist = "SELECT temp_finalist.contestant_num, temp_finalist.municipality, temp_finalist.name, temp_finalist.scores FROM temp_finalist ORDER BY temp_finalist.scores DESC;";
...
<table border="0" align="center">
    ...
    <tr><td>&nbsp;<br /></td></tr>
  <tr><td align="center"><h1><?php echo "Preliminary Results"; ?></h1></td>
  </tr>
</table>
<br />
<table border="1" width="800" align="center" class="contestant">
  <tr>
    <th align="center" width="100" class="contestant">Contestant #</th>
    <th align="center" class="contestant">Municipality</th>
    <th class="contestant">&nbsp;&nbsp;&nbsp;Name</th>
