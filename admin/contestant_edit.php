...
$upd_contestants = new tNG_update($conn_conn_mutya);
$tNGs->addTransaction($upd_contestants);
// Register triggers
$upd_contestants->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_contestants->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_contestants->registerTrigger("END", "Trigger_Default_Redirect", 99, "contestant.php?admin_id=".$curr_admin_id);
// Add columns
$upd_contestants->setTable("contestants");
$upd_contestants->addColumn("contestant_num", "NUMERIC_TYPE", "POST", "contestant_num");
$upd_contestants->addColumn("firstname", "STRING_TYPE", "POST", "firstname");
$upd_contestants->addColumn("lastname", "STRING_TYPE", "POST", "lastname");
$upd_contestants->addColumn("middlename", "STRING_TYPE", "POST", "middlename");
$upd_contestants->addColumn("birthdate", "DATE_TYPE", "POST", "birthdate");
$upd_contestants->addColumn("municipality", "STRING_TYPE", "POST", "municipality");
$upd_contestants->addColumn("address", "STRING_TYPE", "POST", "address");
$upd_contestants->addColumn("photo1", "STRING_TYPE", "POST", "photo1");
$upd_contestants->addColumn("photo2", "STRING_TYPE", "POST", "photo2");
$upd_contestants->addColumn("photo3", "STRING_TYPE", "POST", "photo3");
$upd_contestants->addColumn("photo4", "STRING_TYPE", "POST", "photo4");
$upd_contestants->addColumn("photo5", "STRING_TYPE", "POST", "photo5");
$upd_contestants->setPrimaryKey("contestant_id", "NUMERIC_TYPE", "GET", "contestant_id");
...
?>
      <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          ...
          <tr class="KT_buttons">
            <td colspan="2"><input type="submit" name="btncancel" value="Cancel" /><input type="submit" name="KT_Update1" id="KT_Update1" value="Update record" />
            </td>
          </tr>
        </table>
      </form>
