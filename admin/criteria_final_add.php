...
$ins_final_criteria = new tNG_insert($conn_conn_mutya);
$tNGs->addTransaction($ins_final_criteria);
// Register triggers
$ins_final_criteria->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Insert1");
$ins_final_criteria->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$ins_final_criteria->registerTrigger("END", "Trigger_Default_Redirect", 99, "criteria_final.php");
// Add columns
$ins_final_criteria->setTable("final_criteria");
$ins_final_criteria->addColumn("criteria_name", "STRING_TYPE", "POST", "criteria_name");
$ins_final_criteria->addColumn("info", "STRING_TYPE", "POST", "info");
$ins_final_criteria->setPrimaryKey("criteria_id", "NUMERIC_TYPE");
