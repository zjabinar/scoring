...
$upd_semi_criteria = new tNG_update($conn_conn_mutya);
$tNGs->addTransaction($upd_semi_criteria);
// Register triggers
$upd_semi_criteria->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_semi_criteria->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_semi_criteria->registerTrigger("END", "Trigger_Default_Redirect", 99, "criteria_semifinal.php");
// Add columns
$upd_semi_criteria->setTable("semi_criteria");
$upd_semi_criteria->addColumn("criteria_name", "STRING_TYPE", "POST", "criteria_name");
$upd_semi_criteria->addColumn("info", "STRING_TYPE", "POST", "info");
$upd_semi_criteria->setPrimaryKey("criteria_id", "NUMERIC_TYPE", "GET", "criteria_id");
