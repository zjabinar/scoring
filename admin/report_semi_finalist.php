...
mysql_select_db($database_conn_mutya, $conn_mutya);
$query_finalist = "SELECT temp_finalist.contestant_num, temp_finalist.municipality, temp_finalist.name, temp_finalist.scores FROM temp_finalist ORDER BY temp_finalist.scores DESC limit 0,10;";
