...
$upd_judges = new tNG_update($conn_conn_mutya);
$tNGs->addTransaction($upd_judges);
// Register triggers
$upd_judges->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_judges->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_judges->registerTrigger("END", "Trigger_Default_Redirect", 99, "judges.php?admin_id=".$curr_admin_id);
$upd_judges->registerConditionalTrigger("{POST.password} != {POST.re_password}", "BEFORE", "Trigger_CheckPasswords", 50);
// Add columns
$upd_judges->setTable("judges");
$upd_judges->addColumn("account", "STRING_TYPE", "POST", "account");
$upd_judges->addColumn("password", "STRING_TYPE", "POST", "password");
$upd_judges->addColumn("firstname", "STRING_TYPE", "POST", "firstname");
$upd_judges->addColumn("lastname", "STRING_TYPE", "POST", "lastname");
$upd_judges->addColumn("middlename", "STRING_TYPE", "POST", "middlename");
$upd_judges->addColumn("sex", "STRING_TYPE", "POST", "sex");
$upd_judges->addColumn("profession", "STRING_TYPE", "POST", "profession");
$upd_judges->addColumn("company_name", "STRING_TYPE", "POST", "company_name");
$upd_judges->addColumn("company_address", "STRING_TYPE", "POST", "company_address");
$upd_judges->setPrimaryKey("judgeid", "NUMERIC_TYPE", "GET", "judgeid");
